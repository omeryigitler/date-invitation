...
const foodOptions: Record<MealTime, { label: string; image: string; desc: string }[]> = {
  Sabah: [
    {
      label: 'Pancake & Kahve',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1533089859715-31187c4e3ee9?w=1200&q=80',
      desc: 'Zengin çeşitleriyle geleneksel ve keyifli bir sabah ziyafeti.',
    },
    {
      label: 'Kruvasan & Çay',
      image: 'https://images.unsplash.com/photo-1495147466023-ac5c588e2e94?w=1200&q=80',
      desc: 'Zarif ve hafif. Taze fırından çıkmış kruvasan.',
    },
    {
      label: 'Sağlıklı Kase',
      image: 'https://images.unsplash.com/photo-1511690743698-d9d85f2fbf38?w=1200&q=80',
  ...
  Akşam: [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1615141982883-c7da0e69f58f?w=1200&q=80',
      ...
      <div className="grid min-h-[560px] lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div className="relative z-10 min-h-[360px] overflow-hidden border-t border-white/[0.06] bg-[#070708] lg:min-h-[560px] lg:border-l lg:border-t-0">
          <AnimatePresence mode="wait">
            ...
            >
              <ImageWithFallback src={currentOption.image} alt={currentOption.label} label={currentOption.label} className="h-full w-full object-cover" draggable={false} />
            ...
            <div className="flex gap-2.5 overflow-x-auto pb-1">
              {options.map((option, index) => {
                ...
                return (
                  ...
                  >
                    <ImageWithFallback src={option.image} alt={option.label} className="h-full w-full object-cover" />
